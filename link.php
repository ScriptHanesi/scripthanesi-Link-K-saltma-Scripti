				...
				<div>
					<div class="row">
						<div class="col-md-12">
							...
							<div class="text-center">
								<a rel="nofollow" href="http://twitter.com" target="_blank"><span style="font-size: 1.5rem" class="badge badge-dark"><i class="fab fa-twitter-square"></i></span></a>
								<a rel="nofollow" href="http://facebook.com" target="_blank"><span style="font-size: 1.5rem" class="badge badge-dark"><i class="fab fa-facebook-square"></i></span></a>
								<a rel="nofollow" href="mailto:abc@gmail.com" target="_blank"><span style="font-size: 1.5rem" class="badge badge-dark"><i class="fas fa-envelope"></i></span></a>
								<a rel="nofollow" href="http://wa.me/" target="_blank"><span style="font-size: 1.5rem" class="badge badge-dark"><i class="fab fa-whatsapp"></i></span></a>
							</div>
						</div>	
					...
					<div>
						<div class="row">
							<div class="col-md-12">
								...
								<hr>
								<div class="text-center" style="font-weight: 300; font-synthesis: 0.9rem">www.scripthanesi.com</div>
							</div>
						</div>	
						<script type="text/javascript">
							metin="10";
						...
						<div class="card card-stats card-round shadow-lg">
							<div class="card-body">
								<div class="row align-items-center">
									...
									<a style="display: none;" href="https://www.scripthanesi.com" title="ScriptHanesi" rel="follow"></a>
									<div class="col col-stats ml-2">
										<div class="numbers">
					...
					<div class="col-md-10">
						<div class="card card-stats card-round shadow-lg">
							<div class="card-body text-center">
								<p style="margin-bottom: -3px">Bu script <a class="btn-link" href="https://www.scripthanesi.com" rel="follow" title="ScriptHanesi">"ScriptHanesi.com"</a> tarafından hazırlanmıştır
								</p>
							</div>
						</div>
					</div>
